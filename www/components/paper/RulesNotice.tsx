  ...
  return (
    <details className="rounded-2xl border border-border bg-surface px-4 py-3 text-xs leading-relaxed text-foreground-muted">
      ...
      <p className="mt-2">
        ...
        지표 규칙 계정은 그날 활성화된 지표 조합의 신호를 그대로 따르는 대조군입니다. 위험 규칙 계정은
        검증된 위험 신호(낙폭 위험 낮음 = 저변동 + 상승 추세)인 종목만 사서 5거래일 들고, 그 종목이 낙폭 위험
        높음으로 바뀌면 일찍 팝니다 — 방향을 맞히는 게 아니라 위험한 자리를 피하면 결과가 나아지는지 봅니다. 여기 있는
