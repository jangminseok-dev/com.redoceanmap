...
| Role | Size | Weight | 용도 |
|---|---:|---:|---|
| H1 | 36px (모바일) / 42px (md+) | 600 | 홈 히어로. 이 크기를 쓰는 곳은 홈뿐이다 |
| H2 | 20px | 700 | 페이지 제목 |
| H3 | 16px | 600 | 섹션·카드 제목 |
| Body | 14px | 400 | 지배적 본문 크기 |
| Body Small | 12px | 400 | 보조 설명·캡션 |
...
모션을 쓰는 자리는 네 곳으로 제한한다 — 모달·시트 진입, 리스트 stagger, 숫자 변화, 홈 첫 진입. 채팅 스트리밍처럼 이미 빠르게 갱신되는 곳에는 얹지 않는다(오히려 느려 보인다).
