...
{% include card.html img="/assets/img/paper-board-260908b.jpg" bg="dark" title="AI 모의투자 — 로컬 LLM이 굴리는 가상 1억"
...
| 스택 | FastAPI(모듈러 모놀리식·헥사고날) · Next.js 16 · PostgreSQL(pgvector) · Gemma 4(Ollama) + embeddinggemma |
| 문서 갱신일 | 2026년 9월 15일 |
