...
def test_이벤트_영향이_에포크_안에서_고정이다():
    ...
    - 규칙 v3·v4: 아래 값 (어닝·배당락·유상증자는 `price_at` 안에서 합류하므로
      이 지문에는 잡히지 않는다 — 이 값은 **생성 이벤트만**의 지문이다)
    """
    snapshot = {
    ...
    assert digest == "b3903931dca121e41e22d72845d065c79242dd39150df2b73d856359df46abd1"
