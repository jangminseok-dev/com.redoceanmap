...
# 시즌 1 재초기화 — 2026-08-03 15:00 KST. 확정 후 불변이다(21단계, game-strategy §15).
#
# 계수를 크게 바꿨다: 종목 12 → 36개(밈 종목 도입) · σ 재배정 · 이벤트 확률 0.25 → 0.40 ·
# 가격 밴드 도입 · MIN_STORE_SCALE 0.02 → 0.0005. 전부 §1-4의 "계수 변경"이라 원칙대로면
...
GAME_EPOCH_START_UTC = datetime(2026, 8, 3, 6, 0, 0, tzinfo=timezone.utc)
