...
> (`182`)은 창작이 아니다. **만 이상 정수의 백 단위 반올림형**도 인정한다(2026-09-03 —
> "일평균 96,703명"을 "96,700명"으로 되받는 것이 2회 연속 오탐; 천 단위 `97,000`은 여전히
> 창작). 이 정규화들 뒤 남는 것(기사 연도·점수 형식 창작, 단위 환산 액수)이 진짜 검토 대상이다.
>
