...
- mac: C0 → C1 → C2 (chat·market 랭킹·허브 CommercialDataPort). window의 1단계와 겹치는 파일은
  `hub/app/dtos/commercial_data_dto.py` 하나 — C1이 열을 추가할 때 window가 1단계를 끝낸 뒤 fetch.
- window: 1단계 → 2단계 → 3단계 → C3.
